...
var DBGLEVEL=1,COLLISION_MARGIN=4,RAY_MARGIN=580,CAST_MAX_DEPTH=3,BLOCK_SIZE=20,TEXTURE_SIZE=512,NEAR_MARGIN=400,INTERACT_MARGIN=300,MOVE_FWD_SPEED=3,MOVE_REV_SPEED=-3,TURN_SPEED=Math.PI/50,NUM_RAYS=500,DEV_MODE=!1,OFFSET_INTERACT_SAMPLES=20,CULL_NEAR_MARGIN=150,CULL_FAR_MARGIN=-9E3,CULL_SIDE_MARGIN=600,IN_FRONT_MARGIN=0,camera,map,mapData=[],attributes=[],textures=[],samples=[],interacts=[void 0,interact_Door,interact_Panel,interact_Secret,interact_Item,interact_End,interact_Audio],keys=[],keysRepeat=
[],gameTime="00:00:00",gameStarted=!1,gameCompleted=!1,framesRender=0,frameTime=0,width=2*NUM_RAYS+30,height=600,ctx,floorGradient,ceilingGradient;function DBG(a,b){(b&&b<=DBGLEVEL||3==DBGLEVEL)&&console.log(a)}function project(a){return{x:width-450+a.x/1.5,y:50+a.y/1.5}}function projectToLine(a,b){var d=Math.sqrt(b),c=10+a,e=8E3/d;d=255-Math.round(d);0>d&&(d=0);return{p0:{x:2*c,y:300-e},p1:{x:2*c,y:300+e},alpha:d/255}}
...
function draw(a,b){ctx.clearRect(0,0,width,height);ctx.strokeStyle="#ffffff";b&&(ctx.fillStyle=ceilingGradient,ctx.fillRect(20,0,1E3,300),ctx.fillStyle=floorGradient,ctx.fillRect(20,320,1E3,height-300));map.draw(camera,a,b)}function registerMouseEvents(a){var b=document.getElementById("ctrl_"+a);b.onmousedown=function(b){onControls(b,a,!0)};b.onmouseup=function(b){onControls(b,a,!1)};b.onmouseover=function(b){onControls(b,a,1==b.buttons)};b.onmouseleave=function(b){onControls(b,a,!1)}}
function onControls(a,b,d){d?(beginGame(),keys[b]=!0):(keys[b]=!1,keysRepeat[4]=!1)}function beginGame(){gameStarted||(playSample(1),gameStarted=!0,gameCompleted=!1,gameTime=new Date,frameTime=new Date)}function getTimeStr(a){a=Math.round(a/1E3);var b=a%60,d=Math.floor(a/60)%60;a=Math.floor(a/3600);return b=(10>a?"0":"")+a+":"+((10>d?"0":"")+d+":")+((10>b?"0":"")+b)}
